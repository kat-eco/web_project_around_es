...
profileEditButton?.addEventListener("click", () => {
    ...
    const nameInput = profilePopup["formElement"].querySelector(".popup__input_type_name");
    const descriptionInput = profilePopup["formElement"].querySelector(".popup__input_type_description");
